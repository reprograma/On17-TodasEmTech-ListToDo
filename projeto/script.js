...
botaoAdd.addEventListener("click", (evento) => {
  ...
  if (
    novaTarefaInput.value.trim() === "" ||
    novaTarefaInput.value.length === 0
  ) {
    novaTarefaInput.placeholder = "campo invalido!";
    novaTarefaInput.classList.add("placeholder_red", "input_add");
  } else {
...
//Segunda forma de resolver o botão para marcar e desmarcar todos
// botaoMarcar.addEventListener("click", () => {
